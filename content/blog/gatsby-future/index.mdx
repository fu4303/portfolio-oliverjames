...
### Free and open-source
Gatbsy is also free and open source. There's a VC-backed company behind the software ([Gatsby Inc](https://www.gatsbyjs.com/)) just like Automaticc. Gatsby Inc is a _little_ bit smaller than Automaticc, but it's very new. They've assembled a [team of great people](https://www.gatsbyjs.com/about) who clearly care deeply about building a fantastic tool.
